...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default='..data/0926/OwnerHunter/dealed/', help='input data directory')
    ...
    parser.add_argument('--token_num', type=int, default=1495)
